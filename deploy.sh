export S3_FILE_PATH=app-rest-service/`date +"%Y-%m"`/$CIRCLE_BRANCH
...
export EB_APPLICATION=redirectpro-app-rest-service
export EB_ENVIRONMENT=app-rest-service-$CIRCLE_BRANCH
#
